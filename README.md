...
const currentlyWorkingOn = {
    ...
    goals: ["Master cloud architecture", "Build impactful products"],
...
- [How I Built My First Full-Stack Application](https://yourblog.com)
- [Understanding React Hooks: A Deep Dive](https://yourblog.com)
- [Deploying Apps to AWS: A Beginner's Guide](https://yourblog.com)
- [Clean Code Practices Every Developer Should Know](https://yourblog.com)
<!-- BLOG-POST-LIST:END -->
